...
public class Verbs_Activity extends Activity implements OnItemClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.verbs_layout);
		
		lv_verbs = (ListView)findViewById(R.id.list_verbs);
		
		GetWords Help = new GetWords(this);
		General = Help.getWords(6);
		try
		{
			...
			lv_verbs.setAdapter(count_Adapter);	
			lv_verbs.setOnItemClickListener(this);
