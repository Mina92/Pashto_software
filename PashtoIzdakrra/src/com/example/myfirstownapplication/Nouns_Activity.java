...
public class Nouns_Activity extends Activity implements OnItemClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.nouns_layout);

		//Get Controls from XML
		lv_Nouns=(ListView)findViewById(R.id.list_nouns);
		
		GetWords Help = new GetWords(this);
		General = Help.getWords(7);
		try
		{
			...
			lv_Nouns.setAdapter(count_Adapter);	
			lv_Nouns.setOnItemClickListener(this);
