...
public class Sentences_Activity extends Activity implements OnItemClickListener{
	
	ListView lv_Sentences;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.sentences_layout);

		//Get Controls from XML
		lv_Sentences=(ListView)findViewById(R.id.list_sentences);
		GetWords Help = new GetWords(this);
		General = Help.getWords(11);
		try
		{
			...
			lv_Sentences.setAdapter(count_Adapter);	
			lv_Sentences.setOnItemClickListener(this);
