...
public class AnimalsActivity extends Activity implements OnItemClickListener, OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		lv_Animals=(ListView)findViewById(R.id.list_animals);
		test_Animals = (Button)findViewById(R.id.testanimals);
		test_Animals.setOnClickListener(this);
		GetWords Help = new GetWords(this);
		General = Help.getWords(5);
		...
		try
		{
			...
			lv_Animals.setAdapter(count_Adapter);	
			lv_Animals.setOnItemClickListener(this);
		...
		//Setting Adapter
		//ArrayAdapter<String> Animals_Adapter=new ArrayAdapter<String>(this,R.layout.list_layout,listData );
				
		//lv_Animals.setAdapter(Animals_Adapter);
	...
	public void onClick(View v) {
		...
		switch(v.getId())
		{
	case R.id.testanimals:
		//Toast.makeText(this, "Start Quiz", 5000).show();
		Intent i = new Intent(this,Animalsinstructions_Activity.class);
		startActivity(i);
		}
	}
}