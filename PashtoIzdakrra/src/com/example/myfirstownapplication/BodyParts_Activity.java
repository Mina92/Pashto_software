...
public class BodyParts_Activity extends Activity implements OnItemClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.bodyparts_layout);
		
		//Get Controls from XML
		lv_Body=(ListView)findViewById(R.id.list_body);
	
		GetWords Help = new GetWords(this);
		General = Help.getWords(9);
		try
		{
			...
			lv_Body.setAdapter(count_Adapter);	
