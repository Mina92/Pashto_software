...
public class Relations_Activity extends Activity implements OnItemClickListener{

	
	ListView lv_relations;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.relations_layout);
		
		
		//Get Controls from XML
		lv_relations=(ListView)findViewById(R.id.list_relations);
		GetWords Help = new GetWords(this);
		General = Help.getWords(4);
		try
		{
			...
			lv_relations.setAdapter(count_Adapter);	
			lv_relations.setOnItemClickListener(this);
